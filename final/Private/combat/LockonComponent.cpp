...
void ULockonComponent::StartLockOn(float Radius)
{
	...
	FCollisionShape DetectionSphere;
	DetectionSphere.SetSphere(Radius);
	
	FCollisionQueryParams QueryParams;
	QueryParams.AddIgnoredActor(GetOwner());

	FHitResult TraceResult;
	const bool bTargetDetected = GetWorld()->SweepSingleByChannel(
		TraceResult,
		TraceOrigin,
		TraceOrigin,
		FQuat::Identity,
	...
	if (bTargetDetected && IsValid(TraceResult.GetActor()))
	{
		CurrentTargetActor = TraceResult.GetActor();
	}
}